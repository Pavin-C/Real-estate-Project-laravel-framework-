                ...
                <div class="col-lg-8">
                  <div class="intro-body">
                    ...
                    <p class="intro-subtitle intro-price">
                      <a href="{{ url("#") }}"><span class="price-a">rent | $ 12.000</span></a>
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-4">
            <div class="card-box-c foo">
              ...
              <div class="card-footer-c">
                <a href="{{ url("#") }}" class="link-c link-icon">Read more
          ...
          <div class="col-md-12">
            <div class="title-wrap d-flex justify-content-between">
              ...
              <div class="title-link">
                <a href="{{ url("property-grid.html") }}">All Property
                  <span class="bi bi-chevron-right"></span>
                </a>
              </div>
            </div>
                  ...
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
                      <h2 class="card-title-a">
                        <a href="{{ url("property-single.html") }}">206 Mount
                          <br /> Olive Road Two</a>
                      </h2>
                    </div>
                    <div class="card-body-a">
                      ...
                      <a href="{{ url("#") }}" class="link-a">Click here to view
                        <span class="bi bi-chevron-right"></span>
                      </a>
                    </div>
              ...
              <div class="card-box-a card-shadow">
                ...
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
                      <h2 class="card-title-a">
                        <a href="{{ url("property-single.html") }}">157 West
                          <br /> Central Park</a>
                      </h2>
                    </div>
                    <div class="card-body-a">
                      ...
                      <a href="{{ url("property-single.html") }}" class="link-a">Click here to view
                        <span class="bi bi-chevron-right"></span>
                      </a>
                    </div>
                    <div class="card-footer-a">
              ...
              <div class="card-box-a card-shadow">
                ...
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
                      <h2 class="card-title-a">
                        <a href="{{ url("property-single.html") }}">245 Azabu
                          <br /> Nishi Park let</a>
                      </h2>
                    </div>
                    <div class="card-body-a">
              ...
              <div class="card-box-a card-shadow">
                ...
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
                      <h2 class="card-title-a">
                        <a href="{{ url("property-single.html") }}">204 Montal
                          <br /> South Bela Two</a>
                      </h2>
                    </div>
                    <div class="card-body-a">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="title-wrap d-flex justify-content-between">
              ...
              <div class="title-link">
                <a href="{{ url("agents-grid.html") }}">All Agents
                  <span class="bi bi-chevron-right"></span>
                </a>
              </div>
            </div>
              ...
              <div class="card-overlay card-overlay-hover">
                <div class="card-header-d">
                  <div class="card-title-d align-self-center">
                    <h3 class="title-d">
                      <a href="{{ url("agent-single.html") }}" class="link-two">Margaret Sotillo
                        <br> Escala</a>
                    </h3>
                  </div>
                </div>
            ...
            <div class="card-box-d">
              ...
              <div class="card-overlay card-overlay-hover">
                <div class="card-header-d">
                  <div class="card-title-d align-self-center">
                    <h3 class="title-d">
                      <a href="{{ url("agent-single.html") }}" class="link-two">Stiven Spilver
                        <br> Darw</a>
                    </h3>
                  </div>
                </div>
            ...
            <div class="card-box-d">
              ...
              <div class="card-overlay card-overlay-hover">
                <div class="card-header-d">
                  <div class="card-title-d align-self-center">
                    <h3 class="title-d">
                      <a href="{{ url("agent-single.html") }}" class="link-two">Emma Toledo
                        <br> Cascada</a>
                    </h3>
                  </div>
                </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="title-wrap d-flex justify-content-between">
              ...
              <div class="title-link">
                <a href="{{ url("blog-grid.html") }}">All News
                  <span class="bi bi-chevron-right"></span>
                </a>
              </div>
            </div>
                ...
                <div class="card-overlay">
                  <div class="card-header-b">
                    <div class="card-category-b">
                      <a href="{{ url("#") }}" class="category-b">House</a>
                    </div>
                    <div class="card-title-b">
                      <h2 class="title-2">
                        <a href="{{ url("blog-single.html") }}">House is comming
                          <br> new</a>
                      </h2>
                    </div>
                    <div class="card-date">
            ...
            <div class="carousel-item-c swiper-slide">
              <div class="card-box-b card-shadow news-box">
                ...
                <div class="card-overlay">
                  <div class="card-header-b">
                    <div class="card-category-b">
                      <a href="{{ url("#") }}" class="category-b">Travel</a>
                    </div>
                    <div class="card-title-b">
                      <h2 class="title-2">
                        <a href="{{ url("blog-single.html") }}">Travel is comming
                          <br> new</a>
                      </h2>
                    </div>
                    <div class="card-date">
            ...
            <div class="carousel-item-c swiper-slide">
              <div class="card-box-b card-shadow news-box">
                ...
                <div class="card-overlay">
                  <div class="card-header-b">
                    <div class="card-category-b">
                      <a href="{{ url("#") }}" class="category-b">Park</a>
                    </div>
                    <div class="card-title-b">
                      <h2 class="title-2">
                        <a href="{{ url("blog-single.html") }}">Park is comming
                          <br> new</a>
                      </h2>
                    </div>
                    <div class="card-date">
